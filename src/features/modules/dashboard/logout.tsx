          ...
          <DialogContent className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-8 mt-8 ">
              ...
              <p className="text-lg text-[#15322d] font-[500]">
                Logging out now will require you to input your email and
                password in your next sign in. Do you wish to continue?
              </p>
            </div>

            <DialogFooter className="mt-24 flex items-center justify-between">
