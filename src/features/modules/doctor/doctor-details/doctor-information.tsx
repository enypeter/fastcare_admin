const DoctorInformation = () => {
  return (
    <div className="mt-10 mx-6 space-y-8">
      <div>
        <h1 className="text-xl font-medium text-gray-700">Personal Details</h1>
        <div className="grid grid-cols-1 md:grid-cols-2  gap-10 mt-6  ">
          <div>
            <label className="text-gray-800">First Name</label>
            <input className="w-full border-gray-300 border  rounded-lg px-3 py-2 mt-1 outline-none" />
          </div>
      ...
      <div>
        <h1 className="text-xl font-medium text-gray-700">Education/ Qualification</h1>
        <div className="grid grid-cols-1 md:grid-cols-2  gap-10 mt-6  ">
          <div>
